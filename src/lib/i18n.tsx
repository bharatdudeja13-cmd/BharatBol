...
const en = {
  ...
  'verify.intro':
    'Re-read public stand counts in your browser and compare them to what BharatBol displays. You do not have to trust us — that is the point.',
  'verify.run': 'Run the recount now',
  'verify.running': 'Recounting…',
  ...
  'verify.mineNone': 'Take a stand first, then verify it here.',
  'verify.found': 'found',
  'verify.notFound': 'not found yet',
  'verify.checkpoints':
    'Anyone can re-check the live totals against the database. No Merkle theatre while account-linked mode is on.',
...
const hi: Record<keyof typeof en, string> = {
  ...
  'verify.intro':
    'सार्वजनिक गिनती दोबारा पढ़ें और अपने Google खाते के पक्ष देखें। आपको आँख मूँदकर भरोसा करने की ज़रूरत नहीं।',
  'verify.run': 'अभी दोबारा गिनें',
  'verify.running': 'गिनती हो रही है…',
  'verify.displayed': 'दिखाई गई',
  'verify.recount': 'पुनर्गणना',
  'verify.match': 'मेल खाती है',
  'verify.mismatch': 'मेल नहीं खाती',
  'verify.root': 'मर्कल रूट',
  'verify.events': 'घटनाएँ',
  'verify.mine': 'आपके पक्ष',
  'verify.mineNone': 'पहले किसी मुद्दे पर खड़े हों, फिर यहाँ जाँचें।',
  'verify.found': 'मिला',
  'verify.notFound': 'अभी नहीं मिला',
  'verify.checkpoints':
    'कोई भी सार्वजनिक stand_counts को दोबारा पढ़ सकता है और दिखाए गए आँकड़ों से मिला सकता है।',
  'verify.diy': 'स्वयं जाँचें',
