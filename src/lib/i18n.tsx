...
const en = {
  ...
  'verify.accountMode':
    'Account-linked mode: re-read public stand_counts and list the stands on this Google account. Anonymous ballot-log recount is paused while receipts are retired.',
  'verify.mineNoneAccount': 'You have not stood on any issue yet with this account.',
  'nav.feed': 'Feed',
  'nav.add': 'Add to feed',
  'feed.title': 'What India is seeing',
  'feed.sub': 'Citizen evidence by issue and state. Tap Watch to play in sequence — same player everywhere. Nothing is re-hosted.',
  ...
  'add.sub': 'Paste a link to a public post about a civic issue. It appears under Evidences right away — report anything that breaks the rules.',
  ...
  'add.done': 'Live on the feed. Anyone can watch it under Evidences for that issue and state.',
  ...
  'evidence.sub': 'Citizen-submitted clips — unverified. Tap to watch in sequence.',
  'evidence.empty': 'No evidence here yet. Add a public reel or post about this issue.',
  ...
  'evidence.reactHonest': 'Verified engaged citizens — not a census. Useful / Not useful never shows who.',
...
const hi: Record<keyof typeof en, string> = {
  ...
  'verify.accountMode':
    'खाता-जुड़ा मोड: सार्वजनिक stand_counts दोबारा पढ़ें और इस Google खाते के पक्ष सूचीबद्ध करें। रसीदें बंद होने तक गुमनाम ballot_log पुनर्गणना रुकी है।',
  ...
  'feed.sub': 'नागरिक साक्ष्य — मुद्दे और राज्य के अनुसार। “देखें” दबाकर क्रम से चलाएँ — वही प्लेयर हर जगह। यहाँ कुछ भी दोबारा होस्ट नहीं होता।',
  ...
  'add.sub': 'किसी नागरिक मुद्दे पर सार्वजनिक पोस्ट का लिंक चिपकाएँ। यह तुरंत साक्ष्य में दिखेगा — नियम तोड़ने पर रिपोर्ट करें।',
  ...
  'add.done': 'फ़ीड पर लाइव। मुद्दे और राज्य के साक्ष्य में कोई भी देख सकता है।',
  ...
  'evidence.sub': 'नागरिकों द्वारा भेजी क्लिप — असत्यापित। क्रम से देखने के लिए टैप करें।',
  'evidence.empty': 'यहाँ अभी साक्ष्य नहीं। इस मुद्दे पर सार्वजनिक रील या पोस्ट जोड़ें।',
  'evidence.watchAll': 'देखें',
  'evidence.viewState': 'इस राज्य के साक्ष्य देखें',
  'evidence.useful': 'उपयोगी',
  'evidence.notUseful': 'उपयोगी नहीं',
  'evidence.reactHonest': 'सत्यापित सक्रिय नागरिक — जनगणना नहीं। उपयोगी / नहीं — कभी नहीं दिखाता कि कौन।',
