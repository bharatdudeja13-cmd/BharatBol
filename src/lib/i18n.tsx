...
const en = {
  ...
  'stands.sub':
    'Browse every live stand across India - All India issues and those especially relevant in each state. Your home state never hides the rest.',
  'stands.all': 'All',
  'stands.national': 'All India',
  'stands.nationalHint': 'Open nationwide - not tagged to a single state.',
  'stands.stateHint': 'Especially relevant here - still open for anyone to stand.',
  'stands.emptyFilter': 'No stands in this group yet.',
  'stands.filterLabel': 'Filter stands by geography',
  'stands.relevantIn': 'Especially relevant in',
...
const hi: Record<keyof typeof en, string> = {
  ...
  'stands.sub':
    'भारत भर के हर लाइव पक्ष देखें - पूरे भारत के मुद्दे और प्रत्येक राज्य में ख़ास तौर पर प्रासंगिक। आपका गृह राज्य बाकी को नहीं छुपाता।',
  'stands.all': 'सभी',
  'stands.national': 'पूरा भारत',
  'stands.nationalHint': 'देशभर में खुला - किसी एक राज्य से जुड़ा नहीं।',
  'stands.stateHint': 'यहाँ ख़ास प्रासंगिक - फिर भी कोई भी खड़ा हो सकता है।',
  'stands.emptyFilter': 'इस समूह में अभी कोई पक्ष नहीं।',
  'stands.filterLabel': 'भूगोल से पक्ष छाँटें',
  'stands.relevantIn': 'यहाँ ख़ास प्रासंगिक',
