...
const en = {
  ...
  'add.badUrl': 'That link is not supported yet. YouTube, X and Instagram public posts only.',
...
const hi: Record<keyof typeof en, string> = {
  ...
  'add.badUrl': 'यह लिंक अभी समर्थित नहीं है। केवल YouTube, X और Instagram के सार्वजनिक पोस्ट।',
