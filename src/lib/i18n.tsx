...
const en = {
  ...
  'share.publicRecord': 'View signed public record',
  ...
  'feed.sub':
    'Citizen evidence by issue and state. Watch without signing in. Links stay on the original platform, are published immediately after validation, and are audited daily. Who submitted is never shown.',
  ...
  'feed.reportSub': 'A reported item leaves the public feed until review is complete. You do not need an account, and nothing about you is stored.',
  'feed.reportSent': 'Reported. It has been removed from the public feed for review.',
  ...
  'mod.sectionApproved': 'Published - remove if not relevant',
  'mod.reReviewBadge': 'Hidden on report',
  'mod.notAdmin': 'This page is for moderators.',
  'mod.relevanceAffirm': 'This clearly relates to the tagged civic issue',
  'mod.relevanceRequired': 'Affirm relevance before approving.',
  'mod.remove': 'Remove',
  'mod.removed': 'Removed',
  ...
  'policy.reason.personal': 'About a private individual / personal / lifestyle',
  'policy.reason.misinfo': 'Clearly false or misleading',
  'policy.reason.offtopic': 'Not relevant to any civic issue',
  ...
  'about.feedBody':
    'The Feed is how you browse what people are sharing from the ground by issue and state. Valid public links are published immediately, point to the original post, and are never re-hosted. Automated review audits evidence daily. Who submitted is never shown.',
  'about.evidenceTitle': 'Citizen evidence',
  'about.evidenceBody':
    'National media alone is not a reliable sole source for ground truth. Evidence clips are unverified citizen links, useful context before you stand and not a court of truth. Source platforms provide the first safeguard; BharatBol audits evidence daily and removes links that are clearly wrong or break the rules.',
  ...
  'about.privacy1':
    'Stands and reactions are tied to your signed-in account. The database can link an account to an issue. The public site does not print your name unless you opt into the wall.',
  'about.privacy2':
  ...
  'dataRights.whyStands':
    'Account-linked commitments. Operators with database access can see the link; the public site shows counts only.',
  ...
  'plog.intro': 'Each public ledger event contains no name, account, or email. This page lists stand and withdrawal events from the live ledger, and signed Sigstore/Rekor checkpoints make the published sequence independently checkable.',
  ...
  'plog.proves': 'It proves these identity-free stand events exist, are ordered, are timestamped, and match a Merkle root signed into a public transparency log. Anyone can recount the log and get the same totals.',
  'plog.provesNot': 'It does not prove how many unique people stood, and it is not a census. The live application keeps account-linked stand records privately. Exact event times are public, so someone who already knows when a person acted could potentially infer an event on a quiet issue.',
...
const hi: Record<keyof typeof en, string> = {
  ...
  'share.publicRecord': 'हस्ताक्षरित सार्वजनिक रिकॉर्ड देखें',
  ...
  'feed.sub': 'नागरिक साक्ष्य मुद्दे और राज्य के अनुसार। बिना साइन इन देखें। लिंक मूल प्लेटफ़ॉर्म पर रहते हैं, मान्य होने पर तुरंत प्रकाशित होते हैं और हर दिन जाँचे जाते हैं।',
  ...
  'feed.reportSub': 'रिपोर्ट की गई सामग्री समीक्षा पूरी होने तक सार्वजनिक फ़ीड से हट जाती है। खाता ज़रूरी नहीं।',
  'feed.reportSent': 'रिपोर्ट दर्ज हुई। समीक्षा के लिए सामग्री सार्वजनिक फ़ीड से हटा दी गई है।',
  ...
  'mod.sectionApproved': 'प्रकाशित - असंगत हो तो हटाएँ',
  'mod.reReviewBadge': 'रिपोर्ट पर छिपाया गया',
  'mod.notAdmin': 'यह पृष्ठ समीक्षकों के लिए है।',
  'mod.relevanceAffirm': 'यह स्पष्ट रूप से चिह्नित नागरिक मुद्दे से संबंधित है',
  'mod.relevanceRequired': 'स्वीकृत करने से पहले प्रासंगिकता की पुष्टि करें।',
  'mod.remove': 'हटाएँ',
  'mod.removed': 'हटाया गया',
  ...
  'policy.reason.personal': 'किसी निजी व्यक्ति / व्यक्तिगत / जीवनशैली के बारे में',
  'policy.reason.misinfo': 'स्पष्ट रूप से भ्रामक या ग़लत',
  'policy.reason.offtopic': 'किसी नागरिक मुद्दे से संबंधित नहीं',
  ...
  'about.feedBody':
    'फ़ीड से आप ज़मीन से साझा की गई चीज़ें मुद्दे और राज्य के अनुसार देखते हैं। मान्य सार्वजनिक लिंक तुरंत प्रकाशित होते हैं, मूल पोस्ट पर जाते हैं और दोबारा होस्ट नहीं होते। स्वचालित समीक्षा हर दिन साक्ष्य जाँचती है। जमा करने वाला कभी नहीं दिखता।',
  'about.evidenceTitle': 'नागरिक साक्ष्य',
  'about.evidenceBody':
    'राष्ट्रीय मीडिया अकेले ज़मीनी सच का भरोसेमंद स्रोत नहीं। साक्ष्य क्लिप असत्यापित नागरिक लिंक हैं, खड़े होने से पहले संदर्भ हैं और अदालत नहीं। प्लेटफ़ॉर्म की सुरक्षा व्यवस्था पहली जाँच है; BharatBol हर दिन साक्ष्य जाँचता है और स्पष्ट रूप से गलत या नियम तोड़ने वाले लिंक हटाता है।',
  ...
  'about.privacy1':
    'पक्ष और प्रतिक्रियाएँ आपके साइन-इन खाते से जुड़ी हैं। डेटाबेस खाता और मुद्दे को जोड़ सकता है। सार्वजनिक साइट दीवार ऑप्ट-इन के बिना नाम नहीं छापती।',
  'about.privacy2':
  ...
  'plog.intro': 'हर सार्वजनिक बही प्रविष्टि में नाम, खाता या ईमेल नहीं होता। यह पृष्ठ लाइव बही की पक्ष और वापसी प्रविष्टियाँ दिखाता है, और Sigstore/Rekor के हस्ताक्षरित चेकपॉइंट प्रकाशित क्रम को जाँचने योग्य बनाते हैं।',
  ...
  'plog.proves': 'यह सिद्ध करता है कि ये पहचान-रहित पक्ष घटनाएँ मौजूद हैं, क्रमबद्ध और समय-अंकित हैं, और सार्वजनिक पारदर्शिता लॉग में हस्ताक्षरित मर्कल रूट से मेल खाती हैं। कोई भी इन्हें दोबारा गिनकर वही योग पा सकता है।',
  'plog.provesNot': 'यह अलग-अलग लोगों की संख्या सिद्ध नहीं करता और यह जनगणना नहीं है। लाइव ऐप निजी रूप से खाते से जुड़े पक्ष रिकॉर्ड रखता है। सटीक समय सार्वजनिक हैं, इसलिए किसी शांत मुद्दे पर पहले से समय जानने वाला व्यक्ति किसी घटना का अनुमान लगा सकता है।',
